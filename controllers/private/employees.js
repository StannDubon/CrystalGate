const EMPLEADO_API = 'services/admin/usuario.php',
    CARGO_API = 'services/admin/cargo.php';
// Constante para establecer el form e input de buscar.
const SEARCH_FORM = document.getElementById('search-form'),
    SEARCH_INPUT = document.getElementById('search-input');
const BOX_EMPLOYEES = document.getElementById('box-employees');
            ...
            DATA.dataset.forEach(row => {
                ...
                <div class="content-card-admin-info">
                    ...
                    <div class="admin-action-button">
                        <div class="admin-delete-button" onclick="openDelete(${row.id_usuario})"><svg width="14" height="16"
                        ...
                        <div class="admin-edit-button" onclick="openUpdate(${row.id_usuario})"><svg width="13" height="16"
